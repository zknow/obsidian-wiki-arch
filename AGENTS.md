...
2. 讀取每一個新檔案，消化內容後，在 `wiki/people/`、`wiki/events/`、`wiki/concepts/`、`wiki/places/` 或 `wiki/works/` 中建立或更新對應的頁面。
...
5. 每個新頁面應在**正文內容**中自然地使用 `[[wiki 連結]]`，僅連結**確實相關**的頁面。禁止在 Related Pages 區塊或在正文中硬塞無關連結。真的沒有相關頁面時，可以接受暫時沒有連結，也比錯誤連結好。
6. 如果新素材與已有的人物、事件、概念、地點或作品相關，請更新現有頁面，不要重複建立。
7. 如果新素材中出現了重要的新人物、事件、概念、地點或作品，才建立新的頁面。
8. 撰寫時請使用流暢的白話風格，避免文言文或艱澀詞彙。
9. 每次資料整理完成後，必須執行以下兩個任務：
